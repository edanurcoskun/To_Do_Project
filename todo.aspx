                ...
                <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                            <ul class="navbar-nav mr-auto mt-2 mt-lg-0" style="padding-left: 300px;">
                                <li class="nav-item">
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Style="width: 400px;" ValidateRequestMode="Disabled" placeholder="Görev" TextMode="MultiLine"></asp:TextBox>
                                </li>
                                <li class="nav-item" style="padding-top: 10px;">
                                    <asp:DropDownList ID="DropDownList2" runat="server" DataTextField="type" Style="width: 200px; height: 39px;"></asp:DropDownList>
                                </li>
                                <li class="nav-item" style="padding-top: 10px;">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                    <ItemTemplate>
                                        <div class="col-md-12">
                                            ...
                                            <asp:LinkButton ID="btnNext" runat="server" CssClass="btn spinbox-up btn-sm btn-white" Style="float: right; color: black;" CommandName="Next"  CommandArgument='<%#Eval("id") %>'>—></asp:LinkButton>
                                            <asp:LinkButton ID="btnDown" runat="server" CssClass="btn spinbox-up btn-sm btn-white" Style="float: right; color: black;" CommandName="Down" CommandArgument='<%#Eval("id") %>'>Aşağı</asp:LinkButton>
                                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-sm btn-danger" Style="float: right;" OnClientClick="return confirm('Silmek istediğinizden emin misiniz?');" CommandName="Delete" CommandArgument='<%#Eval("id") %>'>Sil</asp:LinkButton>
                                            <asp:LinkButton ID="btnUp" runat="server" CssClass="btn spinbox-up btn-sm btn-white" Style="float: right; color: black;" CommandName="Up" CommandArgument='<%#Eval("id") %>'>Yukarı</asp:LinkButton>
                                            <asp:LinkButton ID="btnUpdate" runat="server" CssClass="btn spinbox-up btn-sm btn-success" Style="float: right;" CommandName="Update" CommandArgument='<%#Eval("id") %>'>Güncelle</asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
                                ...
                                <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_ItemCommand">
                                    <ItemTemplate>
                                        <div class="col-md-12">
                                            ...
                                            <asp:LinkButton ID="btnUp" runat="server" CssClass="btn spinbox-up btn-sm btn-white" Style="float: right; color:black;" CommandName="Up" CommandArgument='<%#Eval("id") %>'>Yukarı</asp:LinkButton>
                                            <asp:LinkButton ID="btnUpdate" runat="server" CssClass="btn spinbox-up btn-sm btn-success" Style="float: right;" CommandName="Update" CommandArgument='<%#Eval("id") %>'>Güncelle</asp:LinkButton>
                                            <asp:LinkButton ID="btnBack" runat="server" CssClass="btn spinbox-up btn-sm btn-white" Style="float: right; color: black;" CommandName="Back" CommandArgument='<%#Eval("id") %>'><—</asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
