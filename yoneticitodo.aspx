<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yoneticitodo.aspx.cs" Inherits="WebApplication1.WebForm3" %>
                ...
                <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            <ul class="navbar-nav mr-auto mt-2 mt-lg-0" style="padding-left:350px;">
                                <li class="nav-item">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                    <ItemTemplate>
                                        <div class="col-md-12">
                                            ...
                                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-sm btn-danger" OnClientClick="return confirm('Silmek istediğinizden emin misiniz?');" CommandName="Delete" Style="float: right;" CommandArgument='<%#Eval("id") %>'>Sil</asp:LinkButton>
