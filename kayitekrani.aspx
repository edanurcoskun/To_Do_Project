<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kayitekrani.aspx.cs" Inherits="WebApplication1.kayitekrani" %>
            ...
            <div class="row" style="height: 50px;">
                <div class="col-sm-6" style="padding-top: 50px;">
                    <div style="padding-top: 20px; text-align: center;">
                        ...
                        <asp:Button ID="Bul" runat="server" Text="Bul" CssClass="btn btn-info btn-sm; ace-icon fa fa-key bigger-110" Style="width: 60px; height: 40px;" OnClick="Bul_Click" />
                    </div>
                    ...
                    <div style="padding-top: 50px; text-align: center;">
                        <asp:TextBox ID="GuncelSifre" runat="server" placeholder="Şifre" TextMode="Password" CssClass="col-xs-10 col-sm-5" AutoCompleteType="Disabled"></asp:TextBox>
                    </div>
                    <div style="padding-top: 50px; text-align: center;">
                ...
                <div class="col-sm-6" style="padding-top: 50px;">
                    ...
                    <div style="padding-top: 50px; text-align: center;">
                        <asp:TextBox ID="sifre" runat="server" placeholder="Şifre" TextMode="Password" CssClass="col-xs-10 col-sm-5" AutoCompleteType="Disabled"></asp:TextBox>
                    </div>
                    <div style="padding-top: 50px; text-align: center;">
